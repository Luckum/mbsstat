...
<h3 class="page-header">
    Редактировать рекламные расходы в категории <?= $category->name ?>
...
<?php $form = ActiveForm::begin([
        ...
        <div class="col-sm-2">
            <select id="period" name="period">
                <?php foreach ($months as $month): ?>
                    <option value="<?= $month ?>" <?php if (date('n', strtotime($ad->period)) == $month): ?> selected <?php endif; ?>>
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <button type="submit" class="btn btn-primary" name="create">Сохранить</button>
        </div>
    </div>
<?php ActiveForm::end(); ?>